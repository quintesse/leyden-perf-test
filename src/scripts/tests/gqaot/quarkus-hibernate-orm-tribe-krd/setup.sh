...
sed 's/999-SNAPSHOT/3.32.0/g' "${TEST_APPS_DIR}/${REPO_NAME}/quarkus-hibernate-orm-tribe-krd/pom.xml" > "${TEST_APPS_DIR}/${REPO_NAME}/quarkus-hibernate-orm-tribe-krd/pom.xml.2"
mv "${TEST_APPS_DIR}/${REPO_NAME}/quarkus-hibernate-orm-tribe-krd/pom.xml.2" "${TEST_APPS_DIR}/${REPO_NAME}/quarkus-hibernate-orm-tribe-krd/pom.xml"
