...
case "${ACTION}" in
    app_start)
        ...
        compile_maven "wrapper" " -Dquarkus.package.jar.aot.enabled=true -DskipITs=false -P Conditional -Dquarkus.package.jar.aot.additional-recording-args=-XX:+UseG1GC "
